...
class GoogleCalendarAdapter extends index_1.Adapter {
            ...
            try {
                ...
                const results = yield Promise.all(userProfiles.map((userProfile) => __awaiter(this, void 0, void 0, function* () {
                    const individualRunStats = __assign({ filterStartDate,
                        filterEndDate }, userProfile, { success: true, runDate: moment_1.default().utc().toDate() });
                    try {
                        // add auth tokens to request
                        opts.auth = yield this.authorize(userProfile.emailAfterMapping);
                        // function to recurse through pageTokens
                        const getEvents = (data) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            const events = yield new Promise((res, rej) => {
                                ...
                                calendar.events.list(opts, (err, d) => err ? rej(err) : res(d));
                            });
                            ...
                            if (events.nextPageToken) {
                                ...
                                return yield getEvents(data);
                            }
                            return data;
                        });
                        const { items } = yield getEvents();
    ...
    runConnectionTest() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this.getBatchData([{ email, emailAfterMapping: email }], moment_1.default().toDate(), moment_1.default().add(-1, 'day').toDate());
                return data;
            }
            catch (error) {
