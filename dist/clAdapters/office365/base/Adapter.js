...
class Office365BaseAdapter extends Adapter_1.default {
    ...
    runConnectionTest(connectionData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const today = () => moment_1.default().utc().startOf('day'), filterStartDate = today().add(-1, 'days').toDate(), filterEndDate = today().toDate(), data = yield this.getBatchData([{
    ...
    getAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const tokenData = JSON.parse(yield request_promise_1.default(tokenRequestOptions));
    ...
    getUserData(options, userData, pageToGet = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const urlParams = lodash_1.default(params)
            ...
            try {
                ...
                const { value: records } = JSON.parse(yield request_promise_1.default(requestOptions)) || {};
                ...
                if (userProfile.getAttachments && records.length) {
                    for (let recIter = 0; recIter < records.length; recIter++) {
                        ...
                        const attachmentData = JSON.parse(yield request_promise_1.default(attachmentOptions)) || {};
